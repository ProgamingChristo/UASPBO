...
import com.example.inventorydesktop.penjualan.DetailPenjualan;
import com.example.inventorydesktop.penjualan.Penjualan;
...
public class PenjualanController {
    ...
    private void fetchPenjualanData() {
        new Thread(() -> {
            try {
                URL url = new URL("http://localhost:3030/api/penjualan");
